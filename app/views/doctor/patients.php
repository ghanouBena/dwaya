                    ...
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8 m-b-0">
                                <h5 class="m-b-0"><?= $v->nom_user.' '.$v->prenom_user ?> <a href="<?= $v->url_doctor ?>" class="edit"><i class="zmdi zmdi-edit"></i></a>&nbsp;&nbsp;<a href="<?= $v->compose_doctor ?>" class="edit"><i class="zmdi zmdi-email"></i></a></h5> <small>Patient</small>
                                <address class="m-b-0">
...
<script>    
    ...
    $('#quartie').change(function() {
        var out='';
        var id_c = $(this).val();
        window.location.href='/doctor/patients/'+id_c;
         $.post("/json/patients",
    {
        nPatient: id_c
    },
