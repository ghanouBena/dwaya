    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="user-info">
            ...
            <div class="admin-action-info"> <span>Welcome</span>
                <h3>Dr. <?= strtoupper(substr($_SESSION['users']['nom_user'], 0, 1)).'.'.$_SESSION['users']['prenom_user'] ?></h3>
                <ul>
                    <li><a data-placement="bottom" title="Go to Inbox" href="/doctor/inbox"><i class="zmdi zmdi-email"></i></a></li>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="/doctor"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>                                               
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Medical Consultation</span> </a>
                    <ul class="ml-menu">
                        <li><a href="/doctor/consultation">Add Medical Consultation</a></li>
                        <li><a href="/doctor/modConsultation">Modify Medical Consultation</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-o"></i><span>Patients</span> </a>
                    <ul class="ml-menu">
                        <li><a href="/doctor/patients">All Patients</a></li>                      
                        <li><a href="javascript:void(0)">Patient Profile</a></li>
                        <li><a href="javascript:void(0)">Patient Invoice</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-email"></i><span>Mail</span> </a>
                    <ul class="ml-menu">
                        <li> <a href="/doctor/inbox">Inbox</a></li>
                        <li> <a href="/doctor/compose">Compose</a></li>
                    </ul>
                </li>
