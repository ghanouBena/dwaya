                                                    ...
                                                    <table id="mainTable" class="table table-striped table-hover js-basic-example dataTable" style="cursor: pointer;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php if($v->data_achet_ord == NULL)echo 'not bought'; else echo $v->data_achet_ord; ?></td>
                                                                <td><?= $v->details ?></td>
                                                                <td><a href="<?= $v->url_doctor ?>" class="btn btn-raised bg-green btn-xs waves-effect" data-id="<?= $v->idordonnance ?>" target="_blank" >Show</a></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </tbody>
