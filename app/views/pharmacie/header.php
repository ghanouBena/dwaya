    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="user-info">
            ...
            <div class="admin-action-info"> <span>Welcome</span>
                <h3>Phr. <?= strtoupper(substr($_SESSION['users']['nom_user'], 0, 1)).'.'.$_SESSION['users']['prenom_user'] ?></h3>
                <ul>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="/pharmacie/accueil"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>                                               
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Medicament</span> </a>
                    <ul class="ml-menu">
                        <li><a href="/pharmacie/disponibilite">Add Disponibilite</a></li>
                        <li><a href="/pharmacie/medicament">All Medicament</a></li>
                    </ul>
                </li>
                
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-o"></i><span>Patients</span> </a>
                    <ul class="ml-menu">
                        <li><a href="/pharmacie/patients">All Patients</a></li>                     
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-email"></i><span>Mail</span> </a>
                    <ul class="ml-menu">
                        <li> <a href="/pharmacie/inbox">Inbox</a></li>
                        <li> <a href="/pharmacie/compose">Compose</a></li>
                    </ul>
                </li>
