                    ...
                    <div class="card">
                        ...
                        <div class="body" id="ordn">
                                        ...
                                        <table id="mainTable" class="table table-striped" style="cursor: pointer;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $v->quantite ?></td>
                                                    <td><?= $v->quantite_reste ?></td>
                                                    <td><?= $v->description ?></td>
                                                    <th clas><?= $v->etat?'bay':'not bay' ?></th>
                                                    <th>
                                                        <?php if(!$v->etat): ?>
                                                        <a  class="btn btn-raised bg-green btn-xs waves-effect" data-id="<?= $v->idordonnance ?>" data-set="<?= $v->idmedicament ?>" data-qnt="<?= $v->quantite_reste ?>" >Validation</a>
                                                    <?php endif; ?>
                                                    </th>
                                                </tr>
                                            <?php endforeach; ?>
                            ...
                            <div class="hidden-print col-md-12 text-right">
                                <p class="m-t-10"><strong>Note: </strong> If all medicament bayed please make validation</p>
                                <?php if(($data['ord'][0]->valide_par == NULL)): ?>
                                <a href="javascript:void(0)" data-id="<?= $v->idordonnance ?>"  class="btn btn-raised btn-success">Valid Ord</a>
                            <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<script src="/data/js/validMed.js"></script>
<script>
