                ...
                <div class="thumbnail card">
                    <div class="body">
                        ...
                        <div class="caption">
                            ...
                            <a href="javascript:void(0);" class="btn btn-raised g-bg-cyan waves-effect waves-effect btn-sm button-demo js-modal-buttons col-sm-12" role="button" data-color="cyan" data-toggle="modal" data-target="#addspe" >Add District</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="thumbnail card">
                    <div class="body">
                        <img src="/data/places/medea.jpg" style="height: 300px;width: 100%;" class="img-thumbnail img-fluid" alt="">
                        <div class="caption">
                            <h3>Modify District</h3>
                            <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                text ever since the 1500s </p>
                            <a href="javascript:void(0);" class="btn btn-raised g-bg-cyan waves-effect waves-effect btn-sm button-demo js-modal-buttons col-sm-12" role="button" data-color="cyan" data-toggle="modal" data-target="#modSpe" >Modify District</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-cyan">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Modify District</h4>
            </div>
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="listQuartie" required="" id="quartie">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="newDistrict" placeholder="District Name" required="">
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="addspe" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-cyan">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Add District</h4>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
            <div class=" col-md-12 ">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="listWilaya" required="" id="wilaya1">
                                        <option value="">-- Wilaya --</option>
                                       <?php if(!empty($data['wilaya'])): ?>
                                        <?php foreach ($data['wilaya'] as $v): ?>
                                            <option value="<?= $v->idwilaya ?>"><?= $v->nom_wilaya ?></option>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="listCity" required="" id="commune1">
                                        <option value="">-- City --</option>
...
<script src="/data/js/district.js"></script>
