        ...
        <div class="row clearfix">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="thumbnail card">
                    <div class="body">
                        <img src="/data/places/Algerie-wilayas.jpg" style="height: 300px;width: 100%;" class="img-thumbnail img-fluid" alt="">
                        <div class="caption">
                            <h3>Add Wilaya</h3>
                            <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                text ever since the 1500s </p>
                            <a href="javascript:void(0);" class="btn btn-raised g-bg-cyan waves-effect waves-effect btn-sm button-demo js-modal-buttons col-sm-12" role="button" data-color="cyan" data-toggle="modal" data-target="#addspe" >Add Wilaya</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="thumbnail card">
                    <div class="body">
                        ...
                        <div class="caption">
                            ...
                            <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                text ever since the 1500s </p>
                            <a href="javascript:void(0);" class="btn btn-raised g-bg-cyan waves-effect waves-effect btn-sm button-demo js-modal-buttons col-sm-12" role="button" data-color="cyan" data-toggle="modal" data-target="#modSpe" >Modify Wilaya</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-cyan">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Modify Wilaya</h4>
            </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="wilaya" placeholder="Wilaya Name" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
...
<div class="modal fade" id="addspe" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-cyan">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Add Wilaya</h4>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
            <div class=" col-md-12 ">
...
<script src="/data/js/wilaya.js"></script>
<script>
