    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="user-info">
            ...
            <div class="admin-action-info"> <span>Welcome</span>
                <h3>Ad. <?= strtoupper(substr($_SESSION['users']['nom_user'], 0, 1)).'.'.$_SESSION['users']['prenom_user'] ?></h3>
                <ul>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="/admin/speciality" class="menu-toggle"><i class="zmdi zmdi-border-color"></i><span>Speciality</span> </a></li>
                <li><a href="/admin/medicament" class="menu-toggle"><i class="zmdi zmdi-square-o"></i><span>Medicament</span> </a></li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-pin-drop"></i><span>Places</span> </a>
                    <ul class="ml-menu">
                        <li><a href="/admin/wilaya" class="menu-toggle"><i class="zmdi zmdi-pin"></i><span>Wilaya</span> </a>
                        </li>
                        <li><a href="/admin/city" class="menu-toggle"><i class="zmdi zmdi-pin"></i><span>City</span> </a>
                        </li>
                        <li><a href="/admin/district" class="menu-toggle"><i class="zmdi zmdi-pin"></i><span>District</span> </a>

                    </ul>
                </li>
                </li>
                <li><a href="/admin/accounts" class="menu-toggle"><i class="zmdi zmdi-assignment-account"></i><span>Accounts</span> </a></li>
