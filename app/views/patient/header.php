...
<div id="morphsearch" class="morphsearch">
    <form class="morphsearch-form">
        <div class="form-group m-0">
            <input value="" type="search" id="search" placeholder="Search Doctors or Pharmacie..." class="form-control morphsearch-input" />
...
<nav class="navbar clearHeader">
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="index.html">Dwaya Site</a> </div>
...
<section> 
    ...
    <aside id="leftsidebar" class="sidebar"> 
        <!-- User Info -->
        <div class="user-info">
            <div class="admin-image"> <img src="<?php echo $this->getDataURI($_SESSION['users']['url_pic']); ?>" alt="" style="height: 80px;"> </div>
            <div class="admin-action-info"> <span>Welcome</span>
                <h3>Pt. <?= strtoupper(substr($_SESSION['users']['nom_user'], 0, 1)).'.'.$_SESSION['users']['prenom_user'] ?></h3>
                <ul>
                    <li><a data-placement="bottom" title="Go to Inbox" href="/patient/inbox"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a data-placement="bottom" title="Go to Profile" href="/patient/profile"><i class="zmdi zmdi-account"></i></a></li>                    
                    <li><a href="javascript:void(0);" class="js-right-sidebar" data-close="true"><i class="zmdi zmdi-settings"></i></a></li>
                    <li><a data-placement="bottom" title="Full Screen" href="/login/logout" ><i class="zmdi zmdi-sign-in"></i></a></li>
                </ul>
            </div>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Consultations</span> </a>
                    <ul class="ml-menu">
                        <li><a href="/patient/consultation">Historique</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-square-o"></i><span>Medicament</span> </a>
                    <ul class="ml-menu">
                        <li><a href="/patient/medicament">Search</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-email"></i><span>Mail</span> </a>
                    <ul class="ml-menu">
                        <li> <a href="/patient/inbox">Inbox</a></li>
                        <li> <a href="/patient/compose">Compose</a></li>
                    </ul>
                </li>
            ...
            <div role="tabpanel" class="tab-pane" id="chat">
                <div class="demo-settings">
                    ...
                    <ul>
                        <li class="online">
                            <div class="media">
                                <a  role="button" tabindex="0"> <img class="media-object " src="/data/assets/images/xs/avatar1.jpg" alt=""> </a>
                        ...
                        <li class="online">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="/data/assets/images/xs/avatar2.jpg" alt=""> </a>
                                <div class="media-body">
                        ...
                        <li class="online">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="/data/assets/images/xs/avatar3.jpg" alt=""> </a>
                                <div class="media-body">
                    ...
                    <ul>
                        <li class="offline">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="/data/assets/images/xs/avatar4.jpg" alt=""> </a>
                                <div class="media-body">
                        ...
                        <li class="online">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="/data/assets/images/xs/avatar1.jpg" alt=""> </a>
                                <div class="media-body">
                                    <span class="name">Joel King</span> <span class="badge badge-outline status"></span>
                                </div>
                            </div>
                        ...
                        <li class="offline">
                            <div class="media"> <a class="pull-left " role="button" tabindex="0"> <img class="media-object " src="/data/assets/images/xs/avatar2.jpg" alt=""> </a>
                                <div class="media-body">
                                    <span class="name">Joel King</span> <span class="badge badge-outline status"></span>
                                </div>
                            </div>
