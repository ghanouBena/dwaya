                ...
                <div class="body mail-single">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <p class="m-b-0"> <span class="text-muted">from</span> <a href="<?= $data['message'][0]->compose_patient ?>" class="text-default"><?= $data['message'][0]->email_user ?> 
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="m-b-10 m-t-10"> Click here to <a href="<?= $data['message'][0]->compose_patient ?>">Reply</a> or <a href="mail-compose.html">Forward</a>
                            </div>
                          </div>
                        </div>
                    </div>
